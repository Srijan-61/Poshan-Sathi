  ...
  return (
    <BrowserRouter>
      ...
      <div className={showSplash ? "hidden" : "block"}>
        ...
        <div className={`min-h-screen bg-neutral-50 dark:bg-neutral-950 transition-colors duration-300 ${user ? "pb-20 md:pb-0" : ""}`}>
          <div className="max-w-4xl mx-auto p-4 md:p-8">
            <Routes>
              ...
              {/* Protected Routes */}
              <Route path="/" element={<ProtectedRoute user={user}><Dashboard logs={logs} budget={targets.dailyBudget} goals={targets.dailyRequirements} onLog={handleLog} /></ProtectedRoute>} />
              <Route path="/cook" element={<ProtectedRoute user={user}><CreateFood onFoodCreated={fetchData} /></ProtectedRoute>} />
              <Route path="/menu" element={<ProtectedRoute user={user}><FoodLibrary onLog={handleLog} /></ProtectedRoute>} />
